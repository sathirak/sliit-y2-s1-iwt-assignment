...
<nav class="navbar navbar-expand-lg navbar-dark bg-black">
    <div class="container">
        <a class="navbar-brand d-lg-none" href="allvehicle.jsp">Vehicle Rental</a>
        <button class="navbar-toggler" type="button" data-bs-toggle="collapse" data-bs-target="#navMenu">
            <span class="navbar-toggler-icon"></span>
        </button>
        <div class="collapse navbar-collapse justify-content-center" id="navMenu">
            <ul class="navbar-nav gap-4">
                <li class="nav-item"><a class="nav-link" href="allvehicle.jsp">Vehicle Dashboard</a></li>
...
<div class="hero">
    <div class="hero-overlay">
        <div class="hero-content">
            ...
            <a href="allvehicle.jsp" class="btn btn-danger btn-lg">Explore Vehicles<i class="fa fa-arrow-right ms-1"></i></a>
        </div>
    </div>
</div>
